                    ...
                    <ul class="list-inline d-flex align-items-center g-mb-0">
                        <li class="list-inline-item d-none d-lg-inline-block">
                            <a class="u-link-v5 g-brd-around g-brd-white-opacity-0_2 g-color-white-opacity-0_7 g-color-white--hover g-font-size-12 g-rounded-20 text-uppercase g-px-20 g-py-10"
                               href="page-apply-1.html">Apply for Fall intake</a>
                        </li>
                ...
                <nav class="js-mega-menu navbar navbar-expand-lg g-px-0 g-py-5 g-py-0--lg">
                    ...
                    <a class="navbar-brand g-max-width-170 g-max-width-200--lg" href="home-page-1.html">
                        ...
                        <img class="img-fluid g-width-80 g-hidden-md-down g-hidden-xl-up"
                             src="assets/img/logo/logo-mini.png" alt="Logo">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-lg-3">
                                            ...
                                            <ul class="list-unstyled g-pr-30 mb-0">
                                                ...
                                                <li class="py-2">
                                                    <a class="d-flex g-color-main g-color-primary--hover g-text-underline--none--hover g-py-5"
                                                       href="page-future-students-1.html">
                                                        Future Students
                                                        <i class="g-color-primary g-font-size-15 g-pos-rel g-top-5 ml-auto material-icons">arrow_forward</i>
                                                    </a>
                                                </li>
                                                <li class="py-2">
                                                    <a class="d-flex g-color-main g-color-primary--hover g-text-underline--none--hover g-py-5"
                                                       href="page-current-students-1.html">
                                                        Current Students
                                                        <i class="g-color-primary g-font-size-15 g-pos-rel g-top-5 ml-auto material-icons">arrow_forward</i>
                                                    </a>
                                                </li>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            ...
                                            <ul class="list-unstyled g-pr-30 mb-0">
                                                <li class="py-2">
                                                    <a class="d-flex g-color-main g-color-primary--hover g-text-underline--none--hover g-py-5"
                                                       href="page-faculty-and-staff-1.html">
                                                        Faculty &amp; Staff
                                                        <i class="g-color-primary g-font-size-15 g-pos-rel g-top-5 ml-auto material-icons">arrow_forward</i>
                                                    </a>
                                                </li>
    ...
    <div class="js-carousel u-carousel-v5"
            ...
            <div class="container">
                ...
                <span class="d-block g-color-white g-font-size-20--md mb-2">
                  Making an Impact : <span
                            class="g-brd-bottom--dashed g-brd-2 g-brd-primary g-color-primary g-font-weight-700 g-pb-2">Careers Day</span>
                </span>
        ...
        <div class="js-slide h-100 g-flex-centered g-bg-img-hero g-bg-pos-top-center g-bg-cover g-bg-black-opacity-0_3--after"
            ...
            <div class="container">
                ...
                <span class="d-block g-color-white g-font-size-20--md mb-2">
                  Fall <span
                            class="g-brd-bottom--dashed g-brd-2 g-brd-primary g-color-primary g-font-weight-700 g-pb-2">Webinar Series</span>
                </span>
                        <span class="d-block g-color-white g-font-secondary g-font-size-25 g-font-size-45--md g-line-height-1_4">
        ...
        <div class="container">
            <form class="row align-items-md-center">
                ...
                <div class="col-md-6 g-mb-30">
                    <input class="form-control u-shadow-v19 g-brd-none g-bg-white g-font-size-16 g-rounded-30 g-px-25 g-py-13"
                    ...
                    <span class="u-icon-v3 u-icon-size--lg u-shadow-v35 g-color-blue g-color-white--hover g-bg-secondary-dark-v1 g-bg-main--hover g-font-size-20 rounded-circle">
                      <i class="icon-finance-067 u-line-icon-pro"></i>
                            ...
                            <div class="media-body">
                                ...
                                <p class="g-font-size-16 mb-0">Unify's unique personality rests on the bedrock values of
                    ...
                    <span class="u-icon-v3 u-icon-size--lg u-shadow-v35 g-color-teal g-color-white--hover g-bg-secondary-dark-v1 g-bg-main--hover g-font-size-20 rounded-circle">
                      <i class="icon-education-124 u-line-icon-pro"></i>
                            ...
                            <div class="media-body">
                                ...
                                <p class="g-font-size-16 mb-0">There is no better way to understand Unify University
                                    than by spending time on campus.</p>
                            </div>
                    ...
                    <span class="u-icon-v3 u-icon-size--lg u-shadow-v35 g-color-brown g-color-white--hover g-bg-secondary-dark-v1 g-bg-main--hover g-font-size-20 rounded-circle">
                      <i class="icon-education-127 u-line-icon-pro"></i>
                            ...
                            <div class="media-body">
                                ...
                                <p class="g-font-size-16 mb-0">Take a tour, learn about admission and financial aid,
                                    speak with current students.</p>
                            </div>
            ...
            <div class="row align-items-lg-center">
                ...
                <div class="col-lg-5 order-lg-1 g-mb-50">
                    ...
                    <div class="mb-5">
                        ...
                        <p class="g-color-white-opacity-0_7">Prime Minister Malcolm Turnbull and NHMRC CEO Professor
                            Anne Kelso announced this week that Unify had received eight Career Development Fellowships,
                            14 Early Career Fellowships, five Practitioner Fellowships, seven Research Fellowships and
                            three Centres of Research Excellence.</p>
                    </div>
    ...
    <div class="container g-mt-minus-70 g-pb-100">
            ...
            <div class="col-sm-6 col-lg-3 g-mb-30 g-mb-20--lg">
                ...
                <div class="g-pa-10">
                  ...
                  <g id="_x31_">
                      ...
                      <circle fill="#ffffff" stroke="#f0f2f8" stroke-width="7" stroke-miterlimit="10" cx="93.5"
                              cy="93.5" r="81"/>
                      <path fill="none" stroke="#49c1aa" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"
                            d="M93.5,12.5
        ...
        <div class="g-max-width-870 mx-auto">
            ...
            <g id="Main_Circle">
                ...
                <linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="323.9412" y1="164.2837" x2="383.4379"
                                y2="129.9333" gradientTransform="matrix(0.9061 0.1165 0.1165 0.8555 21.5988 -26.7912)">
                ...
                <g id="Right">
                    <path fill="none" stroke="#f0f2f8" stroke-width="8" stroke-linecap="round" stroke-miterlimit="10"
                          d="M449.4,119.3h42.9
        ...
        <div class="g-max-width-400 mx-auto">
            ...
            <path fill="none" stroke="#f0f2f8" stroke-width="8" stroke-linecap="round" stroke-miterlimit="10" d="M134,118.1l-113.1,0
              ...
              C173,172.3,148.4,148.2,148.4,118.7L148.4,118.7"/>
                <linearGradient id="SVGID_4_" gradientUnits="userSpaceOnUse" x1="147.9412" y1="164.2837" x2="207.4379"
                                y2="129.9333" gradientTransform="matrix(0.9061 0.1165 0.1165 0.8555 5.0741 -6.294)">
                    <stop offset="0" style="stop-color:#f0f2f8;stop-opacity:0"/>
                    <stop offset="0.5224" style="stop-color:#dbdfe8;stop-opacity:0.4179"/>
                    <stop offset="1" style="stop-color:#ccd1dd;stop-opacity:0.8"/>
                </linearGradient>
                            ...
                            <div class="media mb-3">
                                ...
                                <div class="media-body">
                                    <blockquote
                                        ...
                                        The program offers both a strong theoretical and practical component providing
                                        the solid foundation needed for student teachers to venture out into the realm
                                        of teaching.
                        ...
                        <div class="col-md-9 col-lg-8 g-mb-20">
                            ...
                            <div class="media mb-3">
                                ...
                                <div class="media-body">
                                    <blockquote
                                            class="g-brd-left-none g-color-white g-font-style-italic g-font-size-20 g-pl-0">
                                        I would highly recommend the Unify TESL program – it gave me the training, tools
                        ...
                        <div class="col-md-9 col-lg-8 g-mb-20">
                            ...
                            <div class="media mb-3">
                                ...
                                <div class="media-body">
                                    <blockquote
                                            class="g-brd-left-none g-color-white g-font-style-italic g-font-size-20 g-pl-0">
                                        The TESL training at Unify includes an extremely useful practicum portion where
                                        students get the chance to hone their skills at the front of the class and
    ...
    <div class="g-bg-secondary">
        <div class="container g-py-100">
            ...
            <div class="g-max-width-645 text-center g-mb-60 mx-auto">
                ...
                <p>Grow your business, go global, and boost conversions in other countries by localizing your education
                    experience.</p>
            </div>
            <!-- End Heading -->
                ...
                <li class="u-block-hover u-shadow-v37--hover g-bg-secondary-dark-v1 g-bg-white--hover rounded g-px-50 g-py-30 mb-4">
                    <div class="row align-items-lg-center">
                        ...
                        <div class="col-md-9 col-lg-8 g-mb-30 g-mb-0--lg">
                            <h3 class="h5 g-font-primary g-font-weight-500 mb-1">Health Sciences New Faculty Breakfast
                                &amp; Resource Showcase</h3>
